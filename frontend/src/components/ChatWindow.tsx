...
const DEFAULT_ALPHA_STYLE = { bubble: 'bg-purple-500/10 border-purple-500/30 rounded-tl-none', avatar: 'bg-purple-500/20 border border-purple-500/30', name: 'text-purple-300', icon: '🏦' };
...
function getStyle(msg: WSMessage) {
  ...
  if (msg.agentId?.includes('alpha')) return DEFAULT_ALPHA_STYLE;
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-3 scrollbar-thin">
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full gap-3 text-center">
            ...
            <p className="text-gray-400 text-sm font-medium">Ready to negotiate</p>
            <p className="text-gray-600 text-xs">3 Alpha agents will compete for your capital</p>
          </div>
        ) : (
          messages.map((msg, i) => {
